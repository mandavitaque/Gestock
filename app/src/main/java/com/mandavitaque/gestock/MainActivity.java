...
import com.mandavitaque.gestock.config.CadastroProdutoActivity;
import com.mandavitaque.gestock.config.EstoqueActivity;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //btnLogout = findViewById(R.id.btnMenuLogoutID);
...
//
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.btnMenuLogoutID) {
            deslogarUsuario();
        }
